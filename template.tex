...
\newcommand*{\WaterMark}[2][0.15\paperwidth]{%
  \AddToShipoutPicture*{\AtTextCenter{%
    \parbox[t]{1pt}{\makebox[0pt][c]{%
      \includegraphics[width=#1]{#2}}}}}}
                         
                         \usepackage[masters-t, $if(margin-ratio)$$margin-ratio$,$endif$]{usthesis} % option to replace masters-t with PhD 
                       $if(beamerarticle)$
...
\author{$author-short$}{$author$ \\ \\ \includegraphics[width=70mm]{$logo$}}
$endif$
% $if(logo)$
% \WaterMark{$logo$}
% $endif$
