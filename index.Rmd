...
knitr::opts_chunk$set(warning = FALSE, message = FALSE, echo=FALSE, 
                      fig.align = 'center') # adjust dpi for image
# knitr::opts_chunk$set(warning = FALSE, message = FALSE, echo=FALSE, 
#                       fig.width = 4.5, fig.height = 2.5, fig.align = 'center',
#                       fig.ext = 'png', dev = 'png', dpi = 600) # adjust dpi for image quality/knit speed

library(pacman)
pacman::p_load(tidyverse, glue, huxtable, gridExtra, wesanderson, ggrepel, tsDyn, dplyr) # can load all packages here - don't need to include them separately in the other scripts and RMD files 
